...
const OrderScreen = ({ match, history }) => {
  ...
  useEffect(() => {
    ...
    const addPayPalScript = async () => {
      ...
      script.src = `https://www.paypal.com/sdk/js?client-id=ATy4GrFaVEikGkQ3_Ku1HJkqC358vFyYint83NCKlgV7klaWb8YVMaJsNk-0fRYdIuJuQdGd3VDKJlND`
      script.async = true
      script.onload = () => {
        setSdkReady(true)
      }
